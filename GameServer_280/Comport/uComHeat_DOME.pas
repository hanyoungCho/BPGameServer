...
type
  ...
  public
    ...
    procedure SetHeatUse(ATeeboxNm, AType, AAuto, AStartTm: String);
    ...
    function GetHeatCtlStatus(ATeeboxNm: String): String;
...
procedure TComThreadHeat_DOME.SetHeatUse(ATeeboxNm, AType, AAuto, AStartTm: String); //타석별 제어상태
var
...
function TComThreadHeat_DOME.GetHeatUseStatus(ATeeboxNm: String): String;
var
  nIndex: Integer;
...
begin
  ...
  sHeatCtl := GetHeatCtlStatus(ATeeboxNm);
...
begin
  ...
  sStatus := '0';
  if (FHeatInfoList[8].UseStatus = '1') or (FHeatInfoList[8].UseStatus = '1') or (FHeatInfoList[10].UseStatus = '1') then
    sStatus := '1';
...
function TComThreadHeat_DOME.GetHeatCtlStatus(ATeeboxNm: String): String; //타석에 해당하는 히터정보
begin
